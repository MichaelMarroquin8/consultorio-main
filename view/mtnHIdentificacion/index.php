...
?>
	...
	while ($elemento = readdir($directorio)) {
		if ($elemento != '.' && $elemento != '..') {
			if (is_dir("../../public/documents/documentos/" . $elemento)) {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/HIdentificacion/$elemento' target='_blank'> 
      $elemento/</a>
      <br><br>";
			} else {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/HIdentificacion/$elemento' target='_blank'> 
	...
	if ($_POST["subir"] == "Cargar archivo") {
		$folder = "../../public/documents/documentos/HIdentificacion/";
	...
	if (isset($_POST['borrar'])) {
		@unlink('../../public/documents/documentos/HIdentificacion/' . $borrarFor);
		echo "
									...
									<div class="col-md-6 col-sm-12">
										<div class="card">
											<div class="card-content">
												<div class="card-body">
													<h4 class="card-title">Formato de descarga Identificación de peligros y valoración de riesgos</h4>
