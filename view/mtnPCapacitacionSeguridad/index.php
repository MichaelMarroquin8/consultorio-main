...
?>
	...
	$listar = null;
	$directorio = opendir("../../public/documents/documentos/PCapacitacionSeguridad/");
	$borrarFor=null;

	while ($elemento = readdir($directorio)) {
		if ($elemento != '.' && $elemento != '..') {
			if (is_dir("../../public/documents/documentos/" . $elemento)) {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/PCapacitacionSeguridad/$elemento' target='_blank'> 
      $elemento/</a>
      <br><br>";
			} else {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/PCapacitacionSeguridad/$elemento' target='_blank'> 
	...
	if ($_POST["subir"] == "Cargar archivo") {
		$folder = "../../public/documents/documentos/PCapacitacionSeguridad/";
	...
	if (isset($_POST['borrar'])) {
		@unlink('../../public/documents/documentos/PCapacitacionSeguridad/' . $borrarFor);
		echo "
	  <div class='alert alert-danger'><p class='hidd' align=center>El archivo  " . $_FILES["formato"]["name"] . " ha sido eliminado correctamente. <a href='index.php' class='btn btn-default'>Cliqué aquí </a> para verificar.</div>";
		...
		/////////////ENLISTAR LOS FICHEROS EXISTENTES///////////////////////////////////////////////
		$listarv = null;
		$directoriov = opendir("../../public/videos/PCapacitacionSeguridad/");
	
		while ($elemento = readdir($directoriov)) {
			if ($elemento != '.' && $elemento != '..') {
				if (is_dir("../../public/documents/documentos/" . $elemento)) {
					$listarv .= "<a class=' col-md-6 btn btn-primary block' href='../../public/videos/PCapacitacionSeguridad/$elemento' target='_blank'> 
		  $elemento/</a>
		  <br><br>";
				} else {
					$listarv .= "<a class=' col-md-6 btn btn-primary block' href='../../public/videos/PCapacitacionSeguridad/$elemento' target='_blank'> 
		...
		if ($_POST["subir"] == "Cargar video") {
			$folder = "../../public/videos/PCapacitacionSeguridad/";
			move_uploaded_file($_FILES["formato"]["tmp_name"], "$folder" . $_FILES["formato"]["name"]);
			echo "
		  <div class='alert alert-success'><p class='hidd' align=center>El video  " . $_FILES["formato"]["name"] . " se ha cargado correctamente.<a href='index.php' class='btn btn-default'>Cliqué aquí </a> para verificar.</div>";
		}
		...
		if (isset($_POST['borrarv'])) {
			@unlink('../../public/videos/PCapacitacionSeguridad/' . $borrarForv);
			echo "
		  <div class='alert alert-danger'><p class='hidd' align=center>El archivo  " . $_FILES["formato"]["name"] . " ha sido eliminado correctamente. <a href='index.php' class='btn btn-default'>Cliqué aquí </a> para verificar.</div>";
		}
	...
	<title>CRL-SENA</>::Capacitación en seguridad y salud en el trabajo</title>
	</head>
						...
						<div class="page-title">
							<div class="row">
								<div class="col-12 col-md-6 order-md-1 order-last">
									<h3>Capacitación en seguridad y salud en el trabajo</h3>
								</div>
								<div class="col-12 col-md-6 order-md-2 order-first">
									<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
										<ol class="breadcrumb">
											<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
											<li class="breadcrumb-item active" aria-current="page">Capacitación en seguridad y salud en el trabajo</li>
										</ol>
									</nav>
								</div>
							</div>
							...
							<section id="content-types">
									...
									<div class="col-md-6 col-sm-12">
										<div class="card">
											<div class="card-content">
												<div class="card-body">
													<h4 class="card-title">Formato de descarga Capacitación en seguridad y salud en el trabajo</h4>
								...
								<div class="col-md-6 col-sm-12">
									<div class="card">
										<div class="card-content">
											<div class="card-body">
											<h4 class="card-title">Formato guia de descarga Capacitación en seguridad y salud en el trabajo</h4>
												<form method="post" enctype="multipart/form-data" ">
													<div class="" style=" margin-top:2%; padding:3%; border-radius:20px;">
													<input class="form-control" type="file" name="formato" id="formato" style="margin-bottom:2%;">
