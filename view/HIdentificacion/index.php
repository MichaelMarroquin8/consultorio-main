								...
								<div class="col-md-6 col-sm-12">
									<div class="card">
										<div class="card-content">
											...
											<div class="card-body">
												<h4 class="card-title">Formato: Identificación de peligros y valoración de riesgos</h4>
												<p class="card-text">
								...
								<div class="col-md-6 col-sm-12">
									<div class="card">
										<div class="card-content">
											<img class="card-img-top img-fluid" src="../../public/images/samples/descarga.jpg" alt="Card image cap" style="height: 20rem">
											<div class="card-body">
												<h4 class="card-title">guia o video: Identificación de peligros y valoración de riesgos</h4>
												<p class="card-text">
