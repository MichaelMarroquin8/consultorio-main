...
$(document).on("click","#btneditar", function(){
  ...
  $.post(
    "../../controller/sistemasst.php?op=get_sistemas_seguimiento",
    { sis_sst: sis_sst },
    function (data) {
...
$(document).on("click","#btnactualizar", function(){
  ...
  $.post("../../controller/sistemasst.php?op=update_sistemas_seguimiento", {sis_descrip:esis_descrip}, function (data) {
