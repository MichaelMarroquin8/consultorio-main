...
<?php
	...
	$listar = null;
	$directorio = opendir("../../public/documents/documentos/VInvestigación/");

	while ($elemento = readdir($directorio)) {
		if ($elemento != '.' && $elemento != '..') {
			if (is_dir("../../public/documents/documentos/" . $elemento)) {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/VInvestigación/$elemento' target='_blank'> 
      $elemento/</a>
      <br><br>";
			} else {
				$listar .= "<a class=' col-md-6 btn btn-primary block' href='../../public/documents/documentos/VInvestigación/$elemento' target='_blank'> 
	...
	if ($_POST["subir"] == "Cargar archivo") {
		$folder = "../../public/documents/documentos/VInvestigación/";
	...
	if (isset($_POST['borrar'])) {
		@unlink('../../public/documents/documentos/VInvestigación/' . $borrarFor);
		echo "
