<?php
    class Ticket extends Conectar{
        ...
        public function insert_ticket($usu_id,$emp_id,$cat_id,$cats_id,$tick_titulo,$tick_descrip){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_ticket (tick_id,usu_id,emp_id,cat_id,cats_id,tick_titulo,tick_descrip,tick_estado,fech_crea,usu_asig,fech_asig,est) VALUES (NULL,?,?,?,?,?,?,'Abierto',now(),NULL,NULL,'1');";
        ...
        public function listar_ticket_x_usu($usu_id){
         ...
         public function listar_ticket_x_asig($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT 
                tm_ticket.tick_id,
